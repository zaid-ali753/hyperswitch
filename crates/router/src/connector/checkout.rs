    ...
    > for Checkout
{
    ...
    fn get_request_body(
        ...
        let checkout_req = utils::Encode::<checkout::CaptureRequest>::convert_and_encode(req)
    ...
    fn build_request(
        ...
        Ok(Some(
            services::RequestBuilder::new()
                ...
                // TODO: Use GAT to reduce this
                .url(&PCapture::get_url(self, req, connectors)?)
                .headers(PCapture::get_headers(self, req)?)
                .body(PCapture::get_request_body(self, req)?)
                .build(),
        ))
    }
    fn handle_response(
        ...
        let response: checkout::CaptureResponse = res
            .response
